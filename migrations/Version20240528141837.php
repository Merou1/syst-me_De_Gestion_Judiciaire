 ...
 */
final class Version20240528141837 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dossier CHANGE documents documents JSON DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dossier CHANGE documents documents LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
